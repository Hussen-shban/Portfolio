...
export default function About() {
    ...
    return (
        <div className="pt-32 max-xs:pt-10  " id="About" >
     ...
     border-primary w-[120px] 
      overflow-hidden rounded-full
       bg-slate-600" >
                    ...
                    <div>
                        <p className="flex  
              items-center  gap-2 font-bold text-[28px] " >
    ...
    ">Frontend <br /> Developer</p>
                ...
                <div className="w-[90%]">
                    ...
                    >Hello! I am Hussen, a passionate front-end developer focused on design and user experience. With over 2 of years of experience in web development, I work with technologies such as HTML, CSS, JavaScript, and particularly React and Tailwind CSS.
                        ...
                        Over the past few years, I have built a variety
                         of interactive applications that combine high performance with appealing design. Using React, I enjoy organizing my code and building reusable 
                         
                         

                        {textmore && "custom and attractive interfaces with ease. components, which makes managing and developing applications much easier. As for Tailwind CSS, I appreciate its flexibility and ability to speed up the design process, allowing me to create  I am committed to staying updated with the latest trends in web development, and I consider continuous learning an essential part of my professional journey. I am passionate about enhancing user experience and gathering valuable feedback from users to improve the final outcome.If you have any inquiries or would like to discuss potential projects that align with our vision, please feel free to reach out to me!"}
                    </p>
